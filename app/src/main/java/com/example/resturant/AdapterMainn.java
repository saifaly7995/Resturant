...
public class AdapterMainn extends RecyclerView.Adapter<AdapterMainn.Holderforstore> {
    ...
    public AdapterMainn(List<ListItem> listItems, Context context) {
    ...
    @NonNull
    @Override
    public AdapterMainn.Holderforstore onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {

        LayoutInflater inflater=LayoutInflater.from(parent.getContext());
        View view=inflater.inflate(R.layout.rowrecmain,parent,false);



        return new AdapterMainn.Holderforstore(view);
    }



    @Override
    public void onBindViewHolder(@NonNull AdapterMainn.Holderforstore holder, int position) {
...
//                v.getContext().startActivity(intent);
    ...
    public class Holderforstore extends RecyclerView.ViewHolder{
        ...
        public Holderforstore(@NonNull View itemView) {
            ...
            imgViewff=(ImageView)itemView.findViewById(R.id.img_main);
            ffname=itemView.findViewById(R.id.tv_main_name);
            ffdesc=itemView.findViewById(R.id.tv_main_desc);
            ffprice=itemView.findViewById(R.id.tv_main_price);
