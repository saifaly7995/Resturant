...
public class CartAdapter extends RecyclerView.Adapter<CartAdapter.Holderforstore>  {

    //here we declare attributes for the values we get from database and set in recyclerview
    private List<DeleteModel> listItems;


    private Context context;


    public CartAdapter(List<DeleteModel> listItems, Context context) {
    ...
    @NonNull
    @Override
    public CartAdapter.Holderforstore onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new CartAdapter.Holderforstore(view);
    }
    ...
    @Override
    public void onBindViewHolder(@NonNull final CartAdapter.Holderforstore holder, int position) {


        final DeleteModel lt= listItems.get(position);
...
//                v.getContext().startActivity(intent);
    ...
    public class Holderforstore extends RecyclerView.ViewHolder{
        ...
        public ImageView imgViewff,btndel;
        ...
        public Holderforstore(@NonNull View itemView) {
            ...
            btndel=(ImageView)itemView.findViewById(R.id.btndelitem);
