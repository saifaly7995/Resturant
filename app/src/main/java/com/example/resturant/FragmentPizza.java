...
public class FragmentPizza extends Fragment {
    ...
    static final String url ="https://projectresturent.000webhostapp.com/pizzaapi.php";

    @Nullable
    @Override
    public View onCreateView(@NonNull final LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.pizza,container,false);
        lv=(RecyclerView) view.findViewById(R.id.pizza_list_id);
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            JSONArray jsonArray= jsonObject.getJSONArray("pizza");
                            ...
                            lv.setAdapter(new Adapterpizza(listItems,getContext()));
