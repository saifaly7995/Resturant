...
public class Fragmentfastfood extends Fragment {
    ...
    static final String url ="https://projectresturent.000webhostapp.com/burgerapi.php";

    @Nullable
    @Override
    public View onCreateView(@NonNull final LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.fastfood,container,false);
        lv=(RecyclerView) view.findViewById(R.id.fastfood_list_id);
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            JSONArray jsonArray= jsonObject.getJSONArray("burger");
                            ...
                            lv.setAdapter(new Adapterfastfood(listItems,getContext()));
